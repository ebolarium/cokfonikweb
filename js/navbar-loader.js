            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="index.html" data-tr="ÇOKFONIK" data-en="ÇOKFONIK">ÇOKFONIK</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="koristlerimiz.html" data-tr="KORİSTLERİMİZ" data-en="CHOIR MEMBERS">KORİSTLERİMİZ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="sef-2.html" data-tr="KORO ŞEFİ" data-en="CHOIR DIRECTOR">KORO ŞEFİ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="gecmis-etkinlikler.html" data-tr="GEÇMİŞ ETKİNLİKLER" data-en="PAST EVENTS">GEÇMİŞ ETKİNLİKLER</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="odullerimiz.html" data-tr="ÖDÜLLERİMİZ" data-en="OUR AWARDS">ÖDÜLLERİMİZ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="iletisim.html" data-tr="İLETİŞİM" data-en="CONTACT">İLETİŞİM</a>
                        </li>
                    </ul>
